...
function taskBody(t: Task): Record<string, unknown> {
  return { id: t.id, title: t.title, description: t.description ?? null, priority: t.priority, status: t.status, tags: t.tags, dueDate: t.dueDate ?? null, projectId: t.projectId ?? null, categoryId: t.categoryId ?? null, completedAt: t.completedAt ?? null };
}
